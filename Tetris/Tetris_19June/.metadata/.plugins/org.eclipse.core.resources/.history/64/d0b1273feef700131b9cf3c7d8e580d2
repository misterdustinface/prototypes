...
public class Game implements ApplicationListener {
	...
	public void create() {		
		...
		hudGraphicsData.addDisplay(NEXT_BLOCK_SCREEN, hudScreen.section(0f,	0.5f, 0.4f,0.4f));
		hudGraphicsData.addDisplay(HELD_BLOCK_SCREEN, hudScreen.section(0.5f,0.5f,0.4f,0.4f));
